...
# First six functions will be used to simulate noises in the training data to implement adversarial training
...
def read_conll(handle, input_idx=0, label_idx=2):
    ...
    for sent_string in contents.split('\n\n'):
        ...
        if label_idx < 0:
            ...
            noise_probability = 0.285 # This will be adjusted as needed
            noisy_annotations = []
...
class FinetuneTagger:
    ...
    def __init__(
            ...
            epochs=10, # Number of epochs has been increased to 8 from 5 to handle the increase 
                      # in complexity and diversity given simulated noise in training data
            batchsize=4,
            lr=5e-5
        ):
